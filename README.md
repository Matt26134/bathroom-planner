...
## Upgrade
Upload the contents of `bathroom-planner-v3.0.4-GITHUB-ROOT.zip` directly into the GitHub Pages repository root. The page should show `V3.0.5 · wall risers, mixed water & plumbing focus` and the 3D status should show `renderer V3.0.5`.
...
## V3.0.5 plumbing wall risers and focus view
...
## V3.0.5 saved pipe editing and 3D hit-testing
