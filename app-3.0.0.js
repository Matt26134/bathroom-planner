...
(function(){
"use strict";
const VERSION="3.0.0", KEY="bathroomPlannerStable";
...
ensurePlanVariants();
function save(){syncWorkingToActivePlan();state.version=VERSION;state.schemaVersion=7;state.updatedAt=new Date().toISOString();localStorage.setItem(KEY,JSON.stringify(state))}
