(function(){
  ...
  function exportBathplan(){const s=clone(state());s.version=api.version||s.version;s.schemaVersion=3;s.updatedAt=new Date().toISOString();const pack={bathplanFormat:1,appVersion:api.version||"2.2.2",exportedAt:new Date().toISOString(),assetsEmbedded:true,project:s};download(`${safeName(s.project?.name)}-${new Date().toISOString().slice(0,10)}.bathplan`,JSON.stringify(pack));}
